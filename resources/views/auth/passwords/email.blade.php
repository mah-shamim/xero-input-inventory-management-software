                    ...
                    <div class="tw-px-6 tw-py-4">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="tw-mb-4">
                                ...
                                <input id="email" type="email" class="tw-shadow tw-appearance-none tw-border @error('email') tw-border-red-500 @enderror tw-rounded tw-w-full tw-py-2 tw-px-3 tw-text-gray-700 tw-leading-tight focus:tw-outline-none focus:tw-shadow-outline" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
